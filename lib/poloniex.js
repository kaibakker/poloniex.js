module.exports = (function() {
    ...
    // Constructor
    function Poloniex(key, secret, base_nonce) {
    ...
    Poloniex.prototype = {
        ...
        _private: function(command, parameters, callback, retry = true) {
            ...
            parameters || (parameters = {});
            parameters.command = command;
            parameters.nonce = this.base_nonce + Date.now();
        ...
        returnTradeHistory: function(currencyPair, start, end, callback) {
          var parameters = {currencyPair, start, end};
          return this._private('returnTradeHistory', parameters, callback);
        },

        returnTradeHistoryEZ: function(currencyA, currencyB, callback) {
          var parameters = {
            currencyPair: joinCurrencies(currencyA, currencyB)
          };
